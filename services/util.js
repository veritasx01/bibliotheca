...
/**
 * makes a random {length} long [A-Z][a-z][0-9] string
 * @param {number} length 
...
/**
 * generates a random sample the inclusive range [min,max]
 * @param {number} min 
 * @param {number} max 
 * @returns {number} random sample of range
 */
...
/**
 * Save a JSON-able value to localStorage
 * @param {string} key 
 ...
 * 
 * @param {string} key 
 * @returns {Jsonable} value at that key, if unparseable to json return undefined
 */
